...
export const OurVision = () => {
  return (
    <section className="relative mt-[94px] min-h-[550px] md:mt-[200px]">
      <div
        className="z-0 hidden h-full min-h-[550px] w-full bg-yellow-400 bg-cover bg-center bg-no-repeat md:absolute md:left-0 md:top-0 md:block md:w-1/2 md:rounded-br-[20px] md:rounded-tr-[20px]"
        style={{
